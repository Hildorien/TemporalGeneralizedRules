...
class TGAR(object):
    ...
    def vertical_apriori(self, filepath, min_supp, min_conf, parallel_count=False):
    ...
    def vertical_cumulate(self, filepath, taxonomy_filepath, min_supp, min_conf, min_r, parallel_count=False):
    ...
    def htar(self, filepath, min_supp, min_conf):
    ...
    def htgar(self, filepath, taxonomy_filepath, min_supp, min_conf, min_r):
