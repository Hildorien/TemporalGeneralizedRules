...
dfG = dfS.groupby(['order_id', 'timestamp'])['product_name'].apply(lambda x: list(x)).reset_index()
print(dfG.head())
print(datetime.fromtimestamp(883623600))
print(datetime.fromtimestamp(885006000))