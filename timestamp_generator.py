...
if __name__=="__main__":
    ...
    #generate_timestamped_data(df, '../SyntheticalDatabase/TesisSyntheticDatasets/Transaction/T250k.data', '../SyntheticalDatabase/TesisSyntheticDatasets/Transaction/T250k-timestamped.csv')
